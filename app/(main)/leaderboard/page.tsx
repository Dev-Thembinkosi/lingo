...
const LeaderboaardPage = async () => {
    ...
    const [userProgress, userSubscription, leaderboad] = await Promise.all([userProgressData, userSubscriptionData, leaderboardData]);
            ...
            <FeedWrapper>
                <div className="w-full flex flex-col items-center">
                    <Image 
                        ...
                        width={90}
                    />
                    <h1 className="text-xenter font-bold text-neutral-800 text-2xl my-6">
                        leaderboad
                    </h1>
